...
- [core] `CommandRegistry.registerHandler` registers a new handler with the higher priority than previous [#7539](https://github.com/eclipse-theia/theia/pull/7539)
